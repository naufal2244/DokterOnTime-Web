            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {
                            $header = array("ID Pasien", "Nama Pasien", "Nomor IC/ Paspor", "Nomor Hubungan", "Tanggal Ditambah", "Aksi");
                            $arrlen = count($header);
                            for ($i = 0; $i < $arrlen; $i++) {
                        ...
                        <div class="data-tables">
                            <table id="datatable" class="table" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    $patient_counter = 1; // Initialize patient counter
                                    ...
                                    ?><tr>
                                            <td><?= $patient_counter++; ?></td> <!-- Use the patient counter here -->
                                            ...
                                            <td>
                                                <a href="patient-view.php?cid=<?= encrypt_url($table_row["patient_id"]); ?>" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> Lihat</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
