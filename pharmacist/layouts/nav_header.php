        ...
        <li class="nav-item">
            <div class="btn-group">
                <button type="button" class="btn btn-sm dropdown-toggle btn-profile px-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Hi, <?php echo $apoteker_row["nama_depan"] . ' ' . $apoteker_row["nama_belakang"]; ?>
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- <a href="#" class="dropdown-item"><i class="fa fa-tools mr-2"></i>Settings</a> -->
                    <!-- <a href="password.php" class="dropdown-item"><i class="fa fa-unlock-alt mr-2"></i>Ganti Kata Sandi</a> -->
